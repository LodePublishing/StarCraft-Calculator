...
void ANARACE::generateBasicBuildOrder()
{
...
void ANARACE::crossOver(ANARACE* parent2, ANARACE* child1, ANARACE* child2)
{
	int counter,num;
	counter=MAX_LENGTH;
	ANARACE* c;
