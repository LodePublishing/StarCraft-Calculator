...
double mining[45],gasing[5];
unsigned char Ziel[60],Build_Av[60],Build_Bv[60],tgoal[60]; 
unsigned char Vespene_Av,Max_Build_Types,race,building_types;
...
// TODO: Farben!	
	...
	if(argc<=1)
	{
		printf("HINT: You may directly start scc also with t, p or z as parameter.\n");
